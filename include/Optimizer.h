...
class Optimizer {
  public:
    ...
    void static OptimizeEssentialGraph6DoF(KeyFrame* pCurKF, vector<KeyFrame*>& vpFixedKFs,
    ...
    void static OptimizeEssentialGraph(KeyFrame* pCurKF, const LoopClosing::KeyFrameAndPose& NonCorrectedSim3,
                                       const LoopClosing::KeyFrameAndPose& CorrectedSim3);
    ...
    static int OptimizeSim3(KeyFrame* pKF1, KeyFrame* pKF2, vector<MapPoint*>& vpMatches1,
    ...
    static Eigen::MatrixXd Sparsify(const Eigen::MatrixXd& H, const int& start1, const int& end1, const int& start2,
                                    const int& end2);
