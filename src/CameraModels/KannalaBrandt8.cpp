...
bool KannalaBrandt8::epipolarConstrain_(GeometricCamera* pCamera2, const cv::KeyPoint& kp1, const cv::KeyPoint& kp2,
...
float KannalaBrandt8::TriangulateMatches_(GeometricCamera* pCamera2, const cv::KeyPoint& kp1, const cv::KeyPoint& kp2,
    ...
    cv::Matx44f Tcw2{R21(0, 0), R21(0, 1), R21(0, 2), t21(0), R21(1, 0), R21(1, 1), R21(1, 2), t21(1),
                     R21(2, 0), R21(2, 1), R21(2, 2), t21(2), 0.f,       0.f,       0.f,       1.f};
...
std::ostream& operator<<(std::ostream& os, const KannalaBrandt8& kb) {
    os << kb.mvParameters[0] << " " << kb.mvParameters[1] << " " << kb.mvParameters[2] << " " << kb.mvParameters[3]
       << " " << kb.mvParameters[4] << " " << kb.mvParameters[5] << " " << kb.mvParameters[6] << " "
       << kb.mvParameters[7];
    return os;
}
